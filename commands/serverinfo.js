...
exports.run = async (client, message, args) => {
    ...
    .addField(`:pencil:  Dono do servidor`, `<@${message.guild.ownerID}>`, true)
    .addField(`:pencil:  ID do dono`, message.guild.ownerID, true)
    .addField(':date: Server Criado em', message.guild.createdAt, true)
    .addField(`:closed_lock_with_key: Nível segurança do servidor`, message.guild.verificationLevel, true)
